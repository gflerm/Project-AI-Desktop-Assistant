#!/usr/bin/env python3
"""Convert privacy-safe James JSONL telemetry to CSV and a local analysis report."""
...
SOURCE = ROOT / "captures" / "james-telemetry-2026-08-20.jsonl"
CSV_PATH = ROOT / "captures" / "james-telemetry-2026-08-20.csv"
REPORT = ROOT / "captures" / "james-telemetry-analysis.md"
