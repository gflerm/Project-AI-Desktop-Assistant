#!/usr/bin/env python3
"""Analyze private Project TARS tester recordings using only local Python."""
...
from tars_feedback import migrate_record


ROOT = Path(__file__).resolve().parents[1]
SESSIONS = ROOT / "captures" / "tars-sessions"
REPORT_MD = ROOT / "captures" / "tars-session-analysis.md"
REPORT_JSON = ROOT / "captures" / "tars-session-analysis.json"
